...
import dev.epubby.internal.models.LocalizedDublinCoreModel.Contributor
import dev.epubby.internal.models.LocalizedDublinCoreModel.Coverage
import dev.epubby.internal.models.LocalizedDublinCoreModel.Creator
import dev.epubby.internal.models.LocalizedDublinCoreModel.Description
import dev.epubby.internal.models.LocalizedDublinCoreModel.Publisher
import dev.epubby.internal.models.LocalizedDublinCoreModel.Relation
import dev.epubby.internal.models.LocalizedDublinCoreModel.Rights
import dev.epubby.internal.models.LocalizedDublinCoreModel.Subject
import dev.epubby.internal.models.LocalizedDublinCoreModel.Title
...
internal sealed class DublinCoreModel(internal val name: String) {
    ...
    internal val attributes: MutableMap<String, String> by lazy {
        when (this) {
            ...
            else -> Maps.newHashMapWithExpectedSize<String, String>(0)
        }
    }
