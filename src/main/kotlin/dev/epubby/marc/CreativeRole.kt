...
private val defaultRoles: MutableMap<String, CreativeRole> by lazy {
    getChildObjects<DefaultCreativeRole>().associateByTo(hashMapOf(), { it.code }, { it })
}
...
@JvmOverloads
@JvmName("of")
public fun CreativeRole(code: String, name: String? = null): CreativeRole {
    ...
    return getOrCreateCreativeRole(code, name)
}

// used internally for lenient parsing when deserializing from XML
@JvmSynthetic
internal fun getOrCreateCreativeRole(code: String, name: String? = null): CreativeRole {
