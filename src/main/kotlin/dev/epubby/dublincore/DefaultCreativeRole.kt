...
public sealed class DefaultCreativeRole(override val code: String, override val name: String) : CreativeRole {
    ...
    /**
     * A person, family, or organization contributing to a resource by shortening or condensing the original work but
     * leaving the nature and content of the original work substantially unchanged.
     *
    ...
    /**
     * A person or organization who 1) reworks a musical composition, usually for a different medium, or  2) rewrites
     * novels or stories for motion pictures or other audiovisual medium.
     */
    ...
    /**
     * A person or organization responsible for the submission of an application or who is named as eligible for the
     ...
     * representation intended to show how a building, etc., will look when completed.
     *
    ...
    /**
     * A person, family, or organization contributing to a musical work by rewriting the composition for a medium of
     * performance different from that for which the work was originally intended, or modifying the work for the same
     * medium of performance, etc., such that the musical substance of the original composition remains essentially
     * unchanged.
     *
    ...
    /**
     * A person contributing to a motion picture or television production by overseeing the artists and craftspeople
     * who build the sets.
     */
    public object ArtDirector : DefaultCreativeRole("adi", "Art director")

    /**
     * A person, family, or organization responsible for creating a work by conceiving, and implementing, an original
     * graphic design, drawing, painting, etc.
     *
     * For book illustrators, prefer [Illustrator].
     *
    ...
    /**
     * A person responsible for controlling the development of the artistic style of an entire production, including
    ...
    /**
     * A person or organization associated with or found in an item or collection, which cannot be determined to be
     * that of a [FormerOwner] or other designated relationship indicative of provenance.
     */
    public object AssociatedName : DefaultCreativeRole("asn", "Associated name")

    /**
     * An author, artist, etc., relating him/her to a resource for which there is or once was substantial authority for
     * designating that person as author, creator, etc. of the work.
     *
     ...
     * *(e.g., poems, novels, screenplays, blogs)*.
     *
     * Use also for persons, etc., creating a new work by paraphrasing, rewriting, or adapting works by another creator
     * such that the modification has substantially changed the nature and content of the original or changed the
     ...
     * contribute directly. Such quotations are found particularly in exhibition catalogs, collections of photographs,
     * etc.
     */
    ...
    /**
     * A person or organization responsible for an afterword, postface, colophon, etc. but who is not the chief author
     * of a work.
     */
    ...
    /**
     * A person or organization responsible for an introduction, preface, foreword, or other critical introductory
    ...
    /**
     * A person or organization responsible for a resource upon which the resource represented by the bibliographic
    ...
    /**
     * A person or organization responsible for the binding design of a book, including the type of binding, the type
     * of materials used, and any decorative aspects of the binding.
     *
    ...
    /**
     * A person or organization responsible for writing a commendation or testimonial for a work, which appears on or
     * within the publication itself, frequently on the back or dust jacket of print publications or on advertising
     * material for all media.
     */
    public object BlurbWriter : DefaultCreativeRole("blw", "Blurb writer")

    /**
     * A person or organization involved in manufacturing a manifestation by being responsible for the entire graphic
     * design of a book, including arrangement of type and illustration, choice of materials, and process used.
     *
    ...
    /**
     * A person or organization responsible for the design of flexible covers designed for or published with a book,
    ...
    /**
     * A person or organization who makes books and other bibliographic materials available for purchase. Interest in
     * the materials is primarily lucrative.
     */
    ...
    /**
     * A person, family, or organization involved in broadcasting a resource to an audience via radio, television,
     * webcast, etc.
     */
    ...
    /**
     * A person, family, or organization involved in manufacturing a resource by pouring a liquid or molten substance
     * into a mold and leaving it to solidify to take the shape of the mold.
     */
     ...
     * lighting moods.
     *
     * He or she may also supervise the further processing of filmed material up to the completion of the work print.
     *
    ...
    /**
     * A curator who brings together items from various sources that are then arranged, described, and cataloged as a
     * collection.
     *
     * A collector is neither the creator of the material nor a person to whom manuscripts in the collection may have
     * been addressed.
     */
    public object Collector : DefaultCreativeRole("col", "Collector")

    /**
     * A person, family, or organization involved in manufacturing a manifestation of photographic prints from film
    ...
    /**
     * A person or organization responsible for applying color to drawings, prints, photographs, maps, moving images,
     * etc.
     */
    public object Colorist : DefaultCreativeRole("clr", "Colorist")

    /**
     * A performer contributing to a work by providing interpretation, analysis, or a discussion of the subject matter
     * on a recording, film, or other audiovisual medium.
     */
    ...
    /**
     * A person, family, or organization responsible for creating a new work *(e.g., a bibliography, a directory)*
    ...
    /**
     * A complainant who takes an appeal from one court or jurisdiction to another to reverse the judgment, usually in
     * an equity proceeding.
     */
    public object ComplainantAppellant : DefaultCreativeRole("cpt", "Complainant-appellant")

    /**
     * A complainant against whom an appeal is taken from one court or jurisdiction to another to reverse the judgment,
     * usually in an equity proceeding.
     */
    public object ComplainantAppellee : DefaultCreativeRole("cpe", "Complainant-appellee")

    /**
     * A person, family, or organization responsible for creating or contributing to a musical resource by adding music
     * to a work that originally lacked it or supplements it.
     */
    public object Composer : DefaultCreativeRole("cmp", "Composer")

    /**
     * A person or organization responsible for the creation of metal slug, or molds made of other materials, used to
     * produce the text and images in printed matter.
     *
    ...
    /**
     * A performer contributing to a musical resource by leading a performing group *(orchestra, chorus, opera, etc.)*
     * in a musical or dramatic presentation, etc.
     */
    public object Conductor : DefaultCreativeRole("cnd", "Conductor")

    /**
     * A person or organization responsible for documenting, preserving, or treating printed or manuscript material,
    ...
    /**
     * A person or organization relevant to a resource, who is called upon for professional advice or services in a
     * specialized field of knowledge or training.
     */
    public object Consultant : DefaultCreativeRole("csl", "Consultant")

    /**
     * A person or organization relevant to a resource, who is engaged specifically to provide an intellectual overview
     * of a strategic or operational task and by analysis, specification, or instruction, to create or propose a
    ...
    /**
     * A person*(s)* or organization who opposes, resists, or disputes, in a court of law, a claim, decision, result,
     * etc.
     */
    ...
    /**
     * A person*(s)* or organization defending a claim, decision, result, etc. being opposed, resisted, or disputed
     * in a court of law.
     */
    ...
    /**
     * A person or organization relevant to a resource, who enters into a contract with another person or organization
     * to perform a specific task.
     */
    public object Contractor : DefaultCreativeRole("ctr", "Contractor")

    /**
     * A person, family or organization responsible for making contributions to the resource. This includes those whose
     * work has been contributed to a larger work, such as an anthology, serial publication, or other compilation of
     * individual works. If a more specific role is available, prefer that, e.g. [Editor], [Compiler], [Illustrator].
     *
    ...
    /**
     * A person or organization listed as a copyright owner at the time of registration.
     *
     * Copyright can be granted or later transferred to another person or organization, at which time the claimant
     * becomes the copyright holder.
     */
    public object CopyrightClaimant : DefaultCreativeRole("cpc", "Copyright claimant")

    /**
     * A person or organization to whom copy and legal rights have been granted or transferred for the intellectual
     * content of a work.
     *
     * The copyright holder, although not necessarily the creator of the work, usually has the exclusive right to
     * benefit financially from the sale and use of the work to which the associated copyright protection applies.
     */
    public object CopyrightHolder : DefaultCreativeRole("cph", "Copyright holder")

    /**
     * A person or organization who is a corrector of manuscripts, such as the scriptorium official who corrected the
    ...
    /**
     * A person, family, or organization that designs the costumes for a moving image production or for a musical or
     ...
     * container, etc.
     *
     * For a person or organization responsible for the graphic design of an entire book, use [BookDesigner];
     * for book jackets, use [BookjacketDesigner].
     *
    ...
    /**
     * A person, family, or organization conceiving, aggregating, and/or organizing an exhibition, collection, or other
     * item.
     *
    ...
    /**
     * A defendant who takes an appeal from one court or jurisdiction to another to reverse the judgment, usually in a
     * legal action.
     */
    public object DefendantAppellant : DefaultCreativeRole("dft", "Defendant-appellant")

    /**
     * A defendant against whom an appeal is taken from one court or jurisdiction to another to reverse the judgment,
     * usually in a legal action.
     */
    public object DefendantAppellee : DefaultCreativeRole("dfe", "Defendant-appellee")

    /**
     * A person who is part of a committee that considers the merit of a thesis, dissertation, or other submission by
     * an academic degree candidate.
     */
    ...
    /**
     * A current owner of an item who deposited the item into the custody of another person, family, or organization,
     ...
     * production, publication, or distribution.
     *
     * For major revisions, adaptations, etc., that substantially change the nature and content of the original work,
     * resulting in a new work, see [Author].
     */
     ...
     * together works, or parts of works, by one or more creators.
     *
    ...
    /**
     * A person, family, or organization responsible for assembling, arranging, and trimming film, video, or other
    ...
    /**
     * A person responsible for setting up a lighting rig and focusing the lights for a production, and running the
    ...
    /**
     * A person or organization who creates a duplicate printing surface by pressure molding and electrodepositing
    ...
    /**
     * A person or organization who cuts letters, figures, etc. on a surface, such as a wooden or metal plate used
     * for printing.
     */
    public object Engraver : DefaultCreativeRole("egr", "Engraver")

    /**
     * A person or organization who produces text or images for printing by subjecting metal, glass, or some other
    ...
    /**
     * A person or organization in charge of the description and appraisal of the value of goods,
     * particularly rare items, works of art, etc.
     *
    ...
    /**
     * A person or organization that manages or supervises the work done to collect raw data or do research
     * in an actual setting or environment *(typically applies to the natural and social sciences)*.
     */
    ...
    /**
     * A person, family, or organization involved in distributing a moving image resource to theatres or
     * other distribution channels.
     */
    public object FilmDistributor : DefaultCreativeRole("fds", "Film distributor")

    /**
     * A person who, following the script and in creative cooperation with the Director, selects, arranges,
     * and assembles the filmed material, controls the synchronization of picture and sound, and participates
     * in other post-production tasks such as sound mixing and visual effects processing.
     *
    ...
    /**
     * A person, family or organization responsible for creating an independent or personal film.
     *
    ...
    /**
     * A person or organization who is identified as the only party or the party of the first party.
     *
     * In the case of transfer of rights, this is the assignor, transferor, licensor, grantor, etc.
     *
     * Multiple parties can be named jointly as the first party.
     */
    public object FirstParty : DefaultCreativeRole("fpy", "First party")

    /**
     * A person or organization who makes or imitates something of value or importance, especially with the intent
     * to defraud.
     *
    ...
    /**
     * A person responsible for geographic information system *(GIS)* development and integration with
    ...
    /**
     * A person, family, or organization honored by a work or item *(e.g., the honoree of a festschrift,
     * a person to whom a copy is presented)*.
     *
    ...
    /**
     * A performer contributing to a resource by leading a program *(often broadcast)* that includes other guests,
     * performers, etc. *(e.g., talk show host)*.
     */
    public object Host : DefaultCreativeRole("hst", "Host")

    /**
     * An organization hosting the event, exhibit, conference, etc., which gave rise to a resource, but having little
     * or no responsibility for the content of the resource.
     */
    public object HostInstitution : DefaultCreativeRole("his", "Host institution")

    /**
     * A person providing decoration to a specific item using precious metals or color, often with elaborate designs
     * and motifs.
     */
    public object Illuminator : DefaultCreativeRole("ilu", "Illuminator")

    /**
     * A person, family, or organization contributing to a resource by supplementing the primary content with drawings,
    ...
    /**
     * A person, family or organization responsible for creating or contributing to a resource by responding to an
    ...
    /**
     * A person or organization that takes primary responsibility for a particular activity or endeavor.
     *
     * May be combined with another relator term or code to show the greater importance this person or organization has
     * regarding that particular role.
     *
    ...
    /**
     * A person or organization permitting the temporary use of a book, manuscript, etc., such as for photocopying
     * or microfilming.
     */
    ...
    /**
     * A libelant against whom an appeal is taken from one ecclesiastical court or admiralty to another to reverse
     * the judgment.
     */
    ...
    /**
     * A libelee against whom an appeal is taken from one ecclesiastical court or admiralty to another to reverse
     * the judgment.
     */
    ...
    /**
     * A person or organization who prepares the stone or plate for lithographic printing, including a
     * graphic artist creating a design directly on the surface from which printing will be done.
     */
    ...
    /**
     * A person or organization primarily responsible for compiling and maintaining the original description of a
    ...
    /**
     * A performer contributing to a resource by leading a program *(often broadcast)* where topics are discussed,
    ...
    /**
     * A person who coordinates the activities of the composer, the sound editor, and sound mixers
     * for a moving image production or for a musical or dramatic presentation or entertainment.
     */
    ...
    /**
     * A performer contributing to a resource by reading or speaking in order to give an account of an act, occurrence,
     * course of events, etc.
     */
    public object Narrator : DefaultCreativeRole("nrt", "Narrator")

    /**
     * A performer contributing to an expression of a work by appearing on screen in nonfiction moving image materials
     * or introductions to fiction moving image materials to provide contextual or background information.
     *
    ...
    /**
     * A person or organization performing the work, i.e., the name of a person or organization associated with the
     * intellectual content of the work.
     *
     * This category does not include the publisher or personal affiliation, or sponsor except where it is also
    ...
    /**
     * A person, family, or organization that currently owns an item or collection, i.e.has legal possession
     * of a resource.
     *
    ...
    /**
     * A performer contributing to a resource by participating in a program *(often broadcast)* where
    ...
    /**
     * A person or organization responsible for the production of paper, usually from wood, cloth,
     ...
     * influence to support the work of artists, writers, etc.
     *
     ...
     * or dramatic presentation, etc.
     *
     * If specific codes are used, `prf` is used for a person whose principal skill is not known or specified.
     */
    ...
    /**
     * A plaintiff who takes an appeal from one court or jurisdiction to another to reverse the judgment, usually
     * in a legal proceeding.
     */
    public object PlaintiffAppellant : DefaultCreativeRole("ptt", "Plaintiff-appellant")

    /**
     * A plaintiff against whom an appeal is taken from one court or jurisdiction to another to reverse the judgment,
     * usually in a legal proceeding.
     */
    public object PlaintiffAppellee : DefaultCreativeRole("pte", "Plaintiff-appellee")

    /**
     * A person, family, or organization involved in manufacturing a manifestation by preparing plates used in the
     * production of printed images and/or text.
     */
    public object Platemaker : DefaultCreativeRole("plt", "Platemaker")

    /**
     * A person who is the faculty moderator of an academic disputation, normally proposing a thesis and participating
     * in the ensuing disputation.
     */
    public object Praeses : DefaultCreativeRole("pra", "Praeses")

    /**
     * A person or organization mentioned in an “X presents” credit for moving image materials and who is associated
     * with production, finance, or distribution in some way.
     *
     * A vanity credit; in early years, normally the head of a studio.
     */
    public object Presenter : DefaultCreativeRole("pre", "Presenter")

    /**
     * A person, family, or organization involved in manufacturing a manifestation of printed text, notated music,
    ...
    /**
     * A person, family, or organization responsible for most of the business aspects of a production for screen,
     * audio recording, television, webcast, etc.
     *
     * The producer is generally responsible for fund raising, managing the production, hiring key personnel,
     * arranging for distributors, etc.
     */
    public object Producer : DefaultCreativeRole("pro", "Producer")

    /**
     * An organization that is responsible for financial, technical, and organizational management of a production
    ...
    /**
     * A person or organization associated with the production *(props, lighting, special effects, etc.)* of
    ...
    /**
     * The place of production *(e.g., inscription, fabrication, construction, etc.)* of a resource in an unpublished
     * form.
     */
    ...
    /**
     * A person or organization with primary responsibility for all essential aspects of a project, has
     * overall responsibility for managing projects, or provides overall direction to a project manager.
     */
    ...
    /**
     * A person or organization who produces, publishes, manufactures, or distributes a resource
     * if specific codes are not desired *(e.g. [Manufacturer], [Publisher])*.
     */
    ...
    /**
     * A person or organization who presides over the elaboration of a collective work to ensure its coherence or
    ...
    /**
     * A performer contributing to a resource by manipulating, controlling, or directing puppets or marionettes in
     * a moving image production or a musical or dramatic presentation or entertainment.
     */
    ...
    /**
     * A person or organization who uses a recording device to capture sounds and/or video during a recording session,
     * including field recordings of natural sounds, folkloric events, music, etc.
     */
     ...
     * *(usually in an equity proceeding)* or a candidate for a degree who defends or opposes a thesis provided by the
     * praeses in an academic disputation.
     */
    ...
    /**
     * A respondent against whom an appeal is taken from one court or jurisdiction to another to reverse the judgment,
     * usually in an equity proceeding.
     */
    ...
    /**
     * A person, family, or organization responsible for the set of technical, editorial, and intellectual procedures
     * aimed at compensating for the degradation of an item by bringing it back to a state as close as possible
    ...
    /**
     * A person or organization responsible for parts of a work, often headings or opening parts of a manuscript,
     ...
     *
     * For a person who makes pen-facsimiles, use [Facsimilist].
     */
    ...
    /**
     * A person or organization who is identified as the party of the second part. In the case of transfer of right,
     * this is the assignee, transferee, licensee, grantee, etc. Multiple parties can be named jointly as the
     * second party.
     */
    ...
    /**
     * A person who translates the rough sketches of the art director into actual architectural structures for
     * a theatrical presentation, entertainment, motion picture, etc.
     *
     * Set designers draw the detailed guides and specifications for building the set.
     */
    public object SetDesigner : DefaultCreativeRole("std", "Set designer")

    /**
     * An entity in which the activity or plot of a work takes place, e.g. a geographic place, a time period,
     * a building, an event.
     */
    public object Setting : DefaultCreativeRole("stg", "Setting")

    /**
     * A person whose signature appears without a presentation or other statement indicative of provenance.
     *
     * When there is a presentation statement, use [Inscriber].
     */
    public object Signer : DefaultCreativeRole("sgn", "Signer")

    /**
     * A performer contributing to a resource by using his/her/their voice, with or without instrumental accompaniment,
     * to produce music.
     *
     * A singer's performance may or may not include actual words.
     *
    ...
    /**
     * A person who produces and reproduces the sound score *(both live and recorded)*, the installation of microphones,
     * the setting of sound levels, and the coordination of sources of sound for a production.
     */
    ...
    /**
     * A person or organization contributing to a stage resource through the overall management and
     * supervision of a performance.
     */
    public object StageDirector : DefaultCreativeRole("sgd", "Stage director")

    /**
     * A person who is in charge of everything that occurs on a performance stage, and who acts as chief
     * of all crews and assistant to a director during rehearsals.
     */
    ...
    /**
     * A person under whose supervision a degree candidate develops and presents a thesis, mémoire,
     * or text of a dissertation.
     *
     ...
     * to another.
     *
     * For a work transcribed for a different instrument or performing group, see [Arranger].
     *
     * For makers of pen-facsimiles, use [Facsimilist].
     */
    ...
    /**
     * A person or organization primarily responsible for choice and arrangement of type used in an item.
     *
     * If the typographer is also responsible for other aspects of the graphic design of a book
     * *(e.g., [BookDesigner])*, codes for both functions may be needed.
     */
    public object Typographer : DefaultCreativeRole("tyg", "Typographer")

    /**
     * A place where a university that is associated with a resource is located, for example,
     * a university where an academic dissertation or thesis was presented.
     */
    public object UniversityPlace : DefaultCreativeRole("uvp", "University place")

    /**
     * A person in charge of a video production, e.g. the video recording of a stage production as opposed
     * to a commercial motion picture.
     *
     * The videographer may be the camera operator or may supervise one or more camera operators.
     *
    ...
    /**
     * A writer of words added to an expression of a musical work. For lyric writing in collaboration with a composer
     * to form an original work, see lyricist.
     */
