...
enum class MetadataLinkRelVocabulary(
    ...
    companion object {
        ...
        private val referenceToInstance by lazy {
            values().associateByTo(hashMapOf(), MetadataLinkRelVocabulary::reference)
        }
        ...
        @JvmStatic
        fun fromReferenceOrNull(reference: String): MetadataLinkRelVocabulary? = referenceToInstance[reference]
    }
}