...
enum class ManifestVocabulary(override val reference: String) : Property {
    ...
    override val prefix: Prefix = VocabularyPrefix(URI("http://idpf.org/epub/vocab/package/item/#"))

    companion object {
        @JvmField val PREFIX: Prefix = VocabularyPrefix(URI("http://idpf.org/epub/vocab/package/item/#"))

        private val referenceToInstance by lazy {
            values().associateByTo(hashMapOf(), ManifestVocabulary::reference)
        }
