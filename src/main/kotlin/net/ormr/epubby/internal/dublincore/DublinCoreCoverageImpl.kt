...
internal class DublinCoreCoverageImpl(
    ...
    override fun equals(other: Any?): Boolean = when {
        this === other -> true
        other !is DublinCoreCoverageImpl -> false
