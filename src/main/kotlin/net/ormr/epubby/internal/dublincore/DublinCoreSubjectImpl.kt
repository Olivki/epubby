...
internal class DublinCoreSubjectImpl(
    ...
    override fun equals(other: Any?): Boolean = when {
        this === other -> true
        other !is DublinCoreSubjectImpl -> false
