...
internal object Opf3MetaCreativeRoleConverter : Opf3MetaConverter<CreativeRole> {
    ...
    override fun create(
        ...
        language: String?
    ): Opf3MetaCreativeRoleImpl = Opf3MetaCreativeRoleImpl(
        value = value,
        property = property,
        refines = refines,
    ...
    override fun getType(): KType = typeOf<Opf3MetaCreativeRole>()
}