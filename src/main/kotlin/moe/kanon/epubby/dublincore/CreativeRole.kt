...
import moe.kanon.epubby.dublincore.CreativeRole.Companion.defaultRoles
import moe.kanon.kommons.lang.isUpperCase
...
class CreativeRole private constructor(val code: String, val name: String?) {
    ...
    companion object {
         ...
         */
        @JvmStatic val defaultRoles: ImmutableSet<CreativeRole> by lazy { codeToInstance.values.toImmutableSet() }

        private val codeToInstance = hashMapOf<String, CreativeRole>()

        private fun createConstant(code: String, name: String): CreativeRole {
            val role = CreativeRole(code, name)
            codeToInstance[code] = role
            return role
        }
        ...
        fun of(code: String, name: String? = null): CreativeRole {
            requireThat(!code.isUpperCase()) { "'code' needs to be all lowercase, was '${code}'." }
            requireThat(code.length == 3 && !code.startsWith("oth.")) { "'code' needs to be exactly 3 characters long, was ${code.length}." }
            requireThat(code.length == 7 && code.startsWith("oth.")) { "custom codes need to be exactly 7 characters long, was ${code.length}." }
            return _of(code, name)
        }

        // used internally for lenient parsing when deserializing from XML
        @JvmSynthetic
        internal fun _of(_code: String, name: String? = null): CreativeRole {
            val code = _code.toLowerCase()
            return when {
                codeToInstance.containsKey(code) -> codeToInstance.getValue(code)
         ...
         */
        @JvmField val ABRIDGER: CreativeRole = createConstant("abr", "Abridger")
         ...
         */
        @JvmField val ACTOR: CreativeRole = createConstant("act", "Actor")
         ...
         */
        @JvmField val ADAPTER: CreativeRole = createConstant("adp", "Adapter")

        /**
         * A person, family, or organization to whom the correspondence in a work is addressed.
         */
        @JvmField val ADDRESSEE: CreativeRole = createConstant("rcp", "Addressee")

        /**
         * A person or organization that reviews, examines and interprets data or information in a specific area.
         */
        @JvmField val ANALYST: CreativeRole = createConstant("anl", "Analyst")
         ...
         */
        @JvmField val ANIMATOR: CreativeRole = createConstant("anm", "Animator")

        /**
         * A person who makes manuscript annotations on an item.
         */
        @JvmField val ANNOTATOR: CreativeRole = createConstant("ann", "Annotator")

        /**
         * A person or organization who appeals a lower court's decision.
         */
        @JvmField val APPELLANT: CreativeRole = createConstant("apl", "Appellant")

        /**
         * A person or organization against whom an appeal is taken.
         */
        @JvmField val APPELLEE: CreativeRole = createConstant("ape", "Appellee")
         ...
         */
        @JvmField val APPLICANT: CreativeRole = createConstant("app", "Applicant")
         ...
         */
        @JvmField val ARCHITECT: CreativeRole = createConstant("arc", "Architect")
         ...
         */
        @JvmField val ARRANGER: CreativeRole = createConstant("arr", "Arranger")

        /**
         * A person *(e.g., a painter or sculptor)* who makes copies of works of visual art.
         */
        @JvmField val ART_COPYIST: CreativeRole = createConstant("acp", "Art copyist")
         ...
         */
        @JvmField val ART_DIRECTOR: CreativeRole = createConstant("adi", "Art director")
         ...
         */
        @JvmField val ARTISTIC_DIRECTOR: CreativeRole = createConstant("ard", "Artistic director")

        /**
         * A person or organization to whom a license for printing or publishing has been transferred.
         */
        @JvmField val ASSIGNEE: CreativeRole = createConstant("asg", "Assignee")
         ...
         */
        @JvmField val ASSOCIATED_NAME: CreativeRole = createConstant("asn", "Associated name")
         ...
         */
        @JvmField val ATTRIBUTED_NAME: CreativeRole = createConstant("att", "Attributed name")

        /**
         * A person or organization in charge of the estimation and public auctioning of goods, particularly books,
         * artistic works, etc.
         */
        @JvmField val AUCTIONEER: CreativeRole = createConstant("auc", "Auctioneer")
         ...
         */
        @JvmField val AUTHOR: CreativeRole = createConstant("aut", "Author")
         ...
         * photographs, etc.
         */
        @JvmField val AUTHOR_IN_QUOTATIONS_OR_TEXT_ABSTRACTS: CreativeRole =
         ...
         * author of a work.
         */
        @JvmField val AUTHOR_OF_AFTERWORD: CreativeRole = createConstant("aft", "Author of afterword, colophon, etc.")

        /**
         * A person or organization responsible for the dialog or spoken commentary for a screenplay or sound
         * recording.
         */
        @JvmField val AUTHOR_OF_DIALOG: CreativeRole = createConstant("aud", "Author of dialog")
         ...
         */
        @JvmField val AUTHOR_OF_INTRODUCTION: CreativeRole = createConstant("aui", "Author of introduction, etc.")

        /**
         * A person whose manuscript signature appears on an item.
         */
        @JvmField val AUTOGRAPHER: CreativeRole = createConstant("ato", "Autographer")
         ...
         * indexes, etc.
         */
        @JvmField val BIBLIOGRAPHIC_ANTECEDENT: CreativeRole = createConstant("ant", "Bibliographic antecedent")
         ...
         */
        @JvmField val BLURB_WRITER: CreativeRole = createConstant("blw", "Blurb writer")
         ...
         */
        @JvmField val BOOKSELLER: CreativeRole = createConstant("bsl", "Bookseller")
         ...
         */
        @JvmField val CASTER: CreativeRole = createConstant("cas", "Caster")
         ...
         */
        @JvmField val CENSOR: CreativeRole = createConstant("cns", "Censor")

        /**
         * A person responsible for creating or contributing to a work of movement.
         */
        @JvmField val CHOREOGRAPHER: CreativeRole = createConstant("chr", "Choreographer")
         ...
         */
        @JvmField val CINEMATOGRAPHER: CreativeRole = createConstant("cng", "Cinematographer")

        /**
         * A person or organization for whom another person or organization is acting.
         */
        @JvmField val CLIENT: CreativeRole = createConstant("cli", "Client")

        /**
         * A curator who lists or inventories the items in an aggregate work such as a collection of items or works.
         */
        @JvmField val COLLECTION_REGISTRAR: CreativeRole = createConstant("cor", "Collection registrar")
         ...
         */
        @JvmField val COLLECTOR: CreativeRole = createConstant("col", "Collector")
         ...
         */
        @JvmField val COLLOTYPER: CreativeRole = createConstant("clt", "Collotyper")

        /**
         * A person or organization responsible for applying color to drawings, prints, photographs, maps, moving
         * images, etc.
         */
        @JvmField val COLORIST: CreativeRole = createConstant("clr", "Colorist")
         ...
         */
        @JvmField val COMMENTATOR: CreativeRole = createConstant("cmm", "Commentator")
         ...
         * information, etc.
         */
        @JvmField val COMPILER: CreativeRole = createConstant("com", "Compiler")

        /**
         * A person or organization who applies to the courts for redress, usually in an equity proceeding.
         */
        @JvmField val COMPLAINANT: CreativeRole = createConstant("cpl", "Complainant")
         ...
         */
        @JvmField val COMPLAINANT_APPELLANT: CreativeRole = createConstant("cpt", "Complainant-appellant")
         ...
         */
        @JvmField val COMPLAINANT_APPELLEE: CreativeRole = createConstant("cpe", "Complainant-appellee")
         ...
         */
        @JvmField val COMPOSER: CreativeRole = createConstant("cmp", "Composer")
         ...
         */
        @JvmField val COMPOSITOR: CreativeRole = createConstant("cmt", "Compositor")
         ...
         */
        @JvmField val CONCEPTOR: CreativeRole = createConstant("ccp", "Conceptor")
         ...
         */
        @JvmField val CONDUCTOR: CreativeRole = createConstant("cnd", "Conductor")
         ...
         */
        @JvmField val CONSERVATOR: CreativeRole = createConstant("con", "Conservator")
         ...
         */
        @JvmField val CONSULTANT: CreativeRole = createConstant("csl", "Consultant")
         ...
         */
        @JvmField val CONTRACTOR: CreativeRole = createConstant("ctr", "Contractor")
         ...
         */
        @JvmField val CONTRIBUTOR: CreativeRole = createConstant("ctb", "Contributor")
         ...
         * copyright holder.
         */
        @JvmField val COPYRIGHT_CLAIMANT: CreativeRole = createConstant("cpc", "Copyright claimant")
         ...
         */
        @JvmField val COPYRIGHT_HOLDER: CreativeRole = createConstant("cph", "Copyright holder")
         ...
         */
        @JvmField val CORRECTOR: CreativeRole = createConstant("crr", "Corrector")

        /**
         * A person or organization who was either the writer or recipient of a letter or other communication.
         */
        @JvmField val CORRESPONDENT: CreativeRole = createConstant("crp", "Correspondent")
         ...
         */
        @JvmField val COSTUME_DESIGNER: CreativeRole = createConstant("cst", "Costume designer")

        /**
         * A court governed by court rules, regardless of their official nature *(e.g., laws, administrative
         * regulations)*.
         */
        @JvmField val COURT_GOVERNED: CreativeRole = createConstant("cou", "Court governed")
         ...
         */
        @JvmField val DEFENDANT_APPELLANT: CreativeRole = createConstant("dft", "Defendant-appellant")
         ...
         */
        @JvmField val DEFENDANT_APPELLEE: CreativeRole = createConstant("dfe", "Defendant-appellee")

        /**
         * A organization granting an academic degree.
         */
        @JvmField val DEGREE_GRANTING_INSTITUTION: CreativeRole = createConstant("dgg", "Degree granting institution")

        /**
         * A person overseeing a higher level academic degree.
         */
        @JvmField val DEGREE_SUPERVISOR: CreativeRole = createConstant("dgs", "Degree supervisor")

        /**
         * A person or organization executing technical drawings from others' designs.
         */
        @JvmField val DELINEATOR: CreativeRole = createConstant("dln", "Delineator")

        /**
         * An entity depicted or portrayed in a work, particularly in a work of art.
         */
        @JvmField val DEPICTED: CreativeRole = createConstant("dpc", "Depicted")
         ...
         */
        @JvmField val DRAFTSMAN: CreativeRole = createConstant("drm", "Draftsman")

        /**
         * A person or organization to which authorship has been dubiously or incorrectly ascribed.
         */
        @JvmField val DUBIOUS_AUTHOR: CreativeRole = createConstant("dub", "Dubious author")
         ...
         */
        @JvmField val EDITOR: CreativeRole = createConstant("edt", "Editor")
         ...
         */
        @JvmField val EDITOR_OF_COMPILATION: CreativeRole = createConstant("edc", "Editor of compilation")
         ...
         */
        @JvmField val EDITOR_OF_MOVING_IMAGE_WORK: CreativeRole = createConstant("edm", "Editor of moving image work")
         ...
         */
        @JvmField val ELECTRICIAN: CreativeRole = createConstant("elg", "Electrician")
         ...
         */
        @JvmField val ELECTROTYPER: CreativeRole = createConstant("elt", "Electrotyper")

        /**
         * A jurisdiction enacting a law, regulation, constitution, court rule, etc.
         */
        @JvmField val ENACTING_JURISDICTION: CreativeRole = createConstant("enj", "Enacting jurisdiction")

        /**
         * A person or organization that is responsible for technical planning and design, particularly with
         * construction.
         */
        @JvmField val ENGINEER: CreativeRole = createConstant("eng", "Engineer")

        /**
         * A person or organization who cuts letters, figures, etc. on a surface, such as a wooden or metal plate
         * used for printing.
         */
        @JvmField val ENGRAVER: CreativeRole = createConstant("egr", "Engraver")
         ...
         */
        @JvmField val ETCHER: CreativeRole = createConstant("etr", "Etcher")

        /**
         * A place where an event such as a conference or a concert took place.
         */
        @JvmField val EVENT_PLACE: CreativeRole = createConstant("evp", "Event place")
         ...
         */
        @JvmField val EXPERT: CreativeRole = createConstant("exp", "Expert")

        /**
         * A person or organization that executed the facsimile.
         */
        @JvmField val FACSIMILIST: CreativeRole = createConstant("fac", "Facsimilist")
         ...
         */
        @JvmField val FIELD_DIRECTOR: CreativeRole = createConstant("fld", "Field director")

        /**
         * A director responsible for the general management and supervision of a filmed performance.
         */
        @JvmField val FILM_DIRECTOR: CreativeRole = createConstant("fmd", "Film director")

        /**
         * A person, family, or organization involved in distributing a moving image resource to theatres or other
         * distribution channels.
         */
        @JvmField val FILM_DISTRIBUTOR: CreativeRole = createConstant("fds", "Film distributor")
         ...
         */
        @JvmField val FILM_EDITOR: CreativeRole = createConstant("flm", "Film editor")

        /**
         * A producer responsible for most of the business aspects of a film.
         */
        @JvmField val FILM_PRODUCER: CreativeRole = createConstant("fmp", "Film producer")
         ...
         */
        @JvmField val FILMMAKER: CreativeRole = createConstant("fmk", "Filmmaker")
         ...
         */
        @JvmField val GEOGRAPHIC_INFORMATION_SPECIALIST: CreativeRole =
         ...
         */
        @JvmField val HONOREE: CreativeRole = createConstant("hnr", "Honoree")
         ...
         */
        @JvmField val HOST: CreativeRole = createConstant("hst", "Host")
         ...
         */
        @JvmField val HOST_INSTITUTION: CreativeRole = createConstant("his", "Host institution")

        /**
         * A person providing decoration to a specific item using precious metals or color, often with elaborate
         * designs and motifs.
         */
        @JvmField val ILLUMINATOR: CreativeRole = createConstant("ilu", "Illuminator")
         ...
         */
        @JvmField val ILLUSTRATOR: CreativeRole = createConstant("ill", "Illustrator")

        /**
         * A person who has written a statement of dedication or gift.
         */
        @JvmField val INSCRIBER: CreativeRole = createConstant("ins", "Inscriber")

        /**
         * A performer contributing to a resource by playing a musical instrument.
         */
        @JvmField val INSTRUMENTALIST: CreativeRole = createConstant("itr", "Instrumentalist")
         ...
         */
        @JvmField val INTERVIEWEE: CreativeRole = createConstant("ive", "Interviewee")
         ...
         */
        @JvmField val INTERVIEWER: CreativeRole = createConstant("ivr", "Interviewer")

        /**
         * A person, family, or organization responsible for creating a new device or process.
         */
        @JvmField val INVENTOR: CreativeRole = createConstant("inv", "Inventor")

        /**
         * A person, family or organization issuing a work, such as an official organ of the body.
         */
        @JvmField val ISSUING_BODY: CreativeRole = createConstant("isb", "Issuing body")

        /**
         * A person who hears and decides on legal matters in court.
         */
        @JvmField val JUDGE: CreativeRole = createConstant("jud", "Judge")

        /**
         * A jurisdiction governed by a law, regulation, etc., that was enacted by another jurisdiction.
         */
        @JvmField val JURISDICTION_GOVERNED: CreativeRole = createConstant("jug", "Jurisdiction governed")

        /**
         * An organization that provides scientific analyses of material samples.
         */
        @JvmField val LABORATORY: CreativeRole = createConstant("lbr", "Laboratory")

        /**
         * A person or organization that manages or supervises work done in a controlled setting or environment.
         */
        @JvmField val LABORATORY_DIRECTOR: CreativeRole = createConstant("ldr", "Laboratory director")
         ...
         */
        @JvmField val LANDSCAPE_ARCHITECT: CreativeRole = createConstant("lsa", "Landscape architect")
         ...
         */
        @JvmField val METADATA_CONTACT: CreativeRole = createConstant("mdc", "Metadata contact")

        /**
         * An engraver responsible for decorations, illustrations, letters, etc. cut on a metal surface for printing
         * or decoration.
         */
        @JvmField val METAL_ENGRAVER: CreativeRole = createConstant("mte", "Metal-engraver")

        /**
         * A person, family, or organization responsible for recording the minutes of a meeting.
         */
        @JvmField val MINUTE_TAKER: CreativeRole = createConstant("mtk", "Minute taker")
         ...
         */
        @JvmField val MODERATOR: CreativeRole = createConstant("mod", "Moderator")
         ...
         */
        @JvmField val MONITOR: CreativeRole = createConstant("mon", "Monitor")

        /**
         * A person who transcribes or copies musical notation.
         */
        @JvmField val MUSIC_COPYIST: CreativeRole = createConstant("mcp", "Music copyist")
         ...
         */
        @JvmField val MUSICAL_DIRECTOR: CreativeRole = createConstant("msd", "Musical director")
         ...
         */
        @JvmField val MUSICIAN: CreativeRole = createConstant("mus", "Musician")
         ...
         */
        @JvmField val NARRATOR: CreativeRole = createConstant("nrt", "Narrator")
         ...
         */
        @JvmField val ONSCREEN_PRESENTER: CreativeRole = createConstant("osp", "Onscreen presenter")

        /**
         * A person or organization responsible for opposing a thesis or dissertation.
         */
        @JvmField val OPPONENT: CreativeRole = createConstant("opn", "Opponent")

        /**
         * A person, family, or organization organizing the exhibit, event, conference, etc., which gave rise to a
         * resource.
         */
        @JvmField val ORGANIZER: CreativeRole = createConstant("orm", "Organizer")
         ...
         * individual works.
         */
        @JvmField val PATRON: CreativeRole = createConstant("pat", "Patron")
         ...
         */
        @JvmField val PERFORMER: CreativeRole = createConstant("prf", "Performer")

        /**
         * An organization *(usually a government agency)* that issues permits under which work is accomplished.
         */
        @JvmField val PERMITTING_AGENCY: CreativeRole = createConstant("pma", "Permitting agency")

        /**
         * A person, family, or organization responsible for creating a photographic work.
         */
        @JvmField val PHOTOGRAPHER: CreativeRole = createConstant("pht", "Photographer")

        /**
         * A person or organization who brings a suit in a civil proceeding.
         */
        @JvmField val PLAINTIFF: CreativeRole = createConstant("ptf", "Plaintiff")
         ...
         */
        @JvmField val PLAINTIFF_APPELLANT: CreativeRole = createConstant("ptt", "Plaintiff-appellant")
         ...
         */
        @JvmField val PLAINTIFF_APPELLEE: CreativeRole = createConstant("pte", "Plaintiff-appellee")
         ...
         */
        @JvmField val PLATEMAKER: CreativeRole = createConstant("plt", "Platemaker")
         ...
         */
        @JvmField val PRAESES: CreativeRole = createConstant("pra", "Praeses")
         ...
         */
        @JvmField val PRESENTER: CreativeRole = createConstant("pre", "Presenter")
         ...
         */
        @JvmField val PRINTER_OF_PLATES: CreativeRole = createConstant("pop", "Printer of plates")

        /**
         * A person or organization who makes a relief, intaglio, or planographic printing surface.
         */
        @JvmField val PRINTMAKER: CreativeRole = createConstant("prm", "Printmaker")
         ...
         */
        @JvmField val PROCESS_CONTACT: CreativeRole = createConstant("prc", "Process contact")
         ...
         */
        @JvmField val PRODUCER: CreativeRole = createConstant("pro", "Producer")
         ...
         */
        @JvmField val PRODUCTION_COMPANY: CreativeRole = createConstant("prn", "Production company")

        /**
         * A person or organization responsible for designing the overall visual appearance of a moving image
         * production.
         */
        @JvmField val PRODUCTION_DESIGNER: CreativeRole = createConstant("prs", "Production designer")

        /**
         * A person responsible for all technical and business matters in a production.
         */
        @JvmField val PRODUCTION_MANAGER: CreativeRole = createConstant("pmn", "Production manager")

        /**
         * A person or organization associated with the production *(props, lighting, special effects, etc.)* of a
         * musical or dramatic presentation or entertainment.
         */
        @JvmField val PRODUCTION_PERSONNEL: CreativeRole = createConstant("prd", "Production personnel")

        /**
         * The place of production *(e.g., inscription, fabrication, construction, etc.)* of a resource in an
         * unpublished form.
         */
        @JvmField val PRODUCTION_PLACE: CreativeRole = createConstant("prp", "Production place")

        /**
         * A person, family, or organization responsible for creating a computer program.
         */
        @JvmField val PROGRAMMER: CreativeRole = createConstant("prg", "Programmer")
         ...
         */
        @JvmField val PROJECT_DIRECTOR: CreativeRole = createConstant("pdr", "Project director")

        /**
         * A person who corrects printed matter. For manuscripts, use [CORRECTOR].
         */
        @JvmField val PROOFREADER: CreativeRole = createConstant("pfr", "Proofreader")
         ...
         */
        @JvmField val PROVIDER: CreativeRole = createConstant("prv", "Provider")

        /**
         * The place where a resource is published.
         */
        @JvmField val PUBLICATION_PLACE: CreativeRole = createConstant("pup", "Publication place")

        /**
         * A person or organization responsible for publishing, releasing, or issuing a resource.
         */
        @JvmField val PUBLISHER: CreativeRole = createConstant("pbl", "Publisher")
         ...
         */
        @JvmField val PUBLISHING_DIRECTOR: CreativeRole = createConstant("pbd", "Publishing director")
         ...
         */
        @JvmField val PUPPETEER: CreativeRole = createConstant("ppt", "Puppeteer")

        /**
         * A director responsible for the general management and supervision of a radio program.
         */
        @JvmField val RADIO_DIRECTOR: CreativeRole = createConstant("rdd", "Radio director")

        /**
         * A producer responsible for most of the business aspects of a radio program.
         */
        @JvmField val RADIO_PRODUCER: CreativeRole = createConstant("rpc", "Radio producer")

        /**
         * A person contributing to a resource by supervising the technical aspects of a sound or video recording
         * session.
         */
        @JvmField val RECORDING_ENGINEER: CreativeRole = createConstant("rce", "Recording engineer")
         ...
         */
        @JvmField val RECORDIST: CreativeRole = createConstant("rcd", "Recordist")

        /**
         * A person or organization who writes or develops the framework for an item without being intellectually
         * responsible for its content.
         */
        @JvmField val REDAKTOR: CreativeRole = createConstant("red", "Redaktor")
         ...
         */
        @JvmField val RENDERER: CreativeRole = createConstant("ren", "Renderer")

        /**
         * A person or organization who writes or presents reports of news or current events on air or in print.
         */
        @JvmField val REPORTER: CreativeRole = createConstant("rpt", "Reporter")
         ...
         */
        @JvmField val REPOSITORY: CreativeRole = createConstant("rps", "Repository")

        /**
         * A person who directed or managed a research project.
         */
        @JvmField val RESEARCH_TEAM_HEAD: CreativeRole = createConstant("rth", "Research team head")

        /**
         * A person who participated in a research project but whose role did not involve direction or management of
         * it.
         */
        @JvmField val RESEARCH_TEAM_MEMBER: CreativeRole = createConstant("rtm", "Research team member")

        /**
         * A person or organization responsible for performing research.
         */
        @JvmField val RESEARCHER: CreativeRole = createConstant("res", "Researcher")
         ...
         */
        @JvmField val RESPONDENT: CreativeRole = createConstant("rsp", "Respondent")

        /**
         * A respondent who takes an appeal from one court or jurisdiction to another to reverse the judgment,
         * usually in an equity proceeding.
         */
        @JvmField val RESPONDENT_APPELLANT: CreativeRole = createConstant("rst", "Respondent-appellant")

        /**
         * A respondent against whom an appeal is taken from one court or jurisdiction to another to reverse the
         * judgment, usually in an equity proceeding.
         */
        @JvmField val RESPONDENT_APPELLEE: CreativeRole = createConstant("rse", "Respondent-appellee")

        /**
         * A person or organization legally responsible for the content of the published material.
         */
        @JvmField val RESPONSIBLE_PARTY: CreativeRole = createConstant("rpy", "Responsible party")
         ...
         */
        @JvmField val RESTAGER: CreativeRole = createConstant("rsg", "Restager")
         ...
         */
        @JvmField val RUBRICATOR: CreativeRole = createConstant("rbr", "Rubricator")
         ...
         */
        @JvmField val SCENARIST: CreativeRole = createConstant("sce", "Scenarist")
         ...
         */
        @JvmField val SCIENTIFIC_ADVISOR: CreativeRole = createConstant("sad", "Scientific advisor")

        /**
         * An author of a screenplay, script, or scene.
         */
        @JvmField val SCREENWRITER: CreativeRole = createConstant("aus", "Screenwriter")
         ...
         */
        @JvmField val SCRIBE: CreativeRole = createConstant("scr", "Scribe")

        /**
         * An artist responsible for creating a three-dimensional work by modeling, carving, or similar technique.
         */
        @JvmField val SCULPTOR: CreativeRole = createConstant("scl", "Sculptor")
         ...
         * the second party.
         */
        @JvmField val SECOND_PARTY: CreativeRole = createConstant("spy", "Second party")
         ...
         */
        @JvmField val SECRETARY: CreativeRole = createConstant("sec", "Secretary")

        /**
         * A former owner of an item who sold that item to another owner.
         */
        @JvmField val SELLER: CreativeRole = createConstant("sll", "Seller")
         ...
         */
        @JvmField val SET_DESIGNER: CreativeRole = createConstant("std", "Set designer")

        /**
         * An entity in which the activity or plot of a work takes place, e.g. a geographic place, a time period, a
         * building, an event.
         */
        @JvmField val SETTING: CreativeRole = createConstant("stg", "Setting")
         ...
         */
        @JvmField val SIGNER: CreativeRole = createConstant("sgn", "Signer")
         ...
         */
        @JvmField val SINGER: CreativeRole = createConstant("sng", "Singer")
         ...
         */
        @JvmField val STAGE_MANAGER: CreativeRole = createConstant("stm", "Stage manager")

        /**
         * An organization responsible for the development or enforcement of a standard.
         */
        @JvmField val STANDARDS_BODY: CreativeRole = createConstant("stn", "Standards body")

        /**
         * A person or organization who creates a new plate for printing by molding or copying another printing
         * surface.
         */
        @JvmField val STEREOTYPER: CreativeRole = createConstant("str", "Stereotyper")

        /**
         * A performer contributing to a resource by relaying a creator's original story with dramatic or theatrical
         * interpretation.
         */
        @JvmField val STORYTELLER: CreativeRole = createConstant("stl", "Storyteller")
         ...
         */
        @JvmField val SUPPORTING_HOST: CreativeRole = createConstant("sht", "Supporting host")
         ...
         */
        @JvmField val TRANSCRIBER: CreativeRole = createConstant("trc", "Transcriber")
         ...
         */
        @JvmField val TRANSLATOR: CreativeRole = createConstant("trl", "Translator")

        /**
         * A person or organization who designs the type face used in a particular item.
         */
        @JvmField val TYPE_DESIGNER: CreativeRole = createConstant("tyd", "Type designer")
         ...
         */
        @JvmField val UNIVERSITY_PLACE: CreativeRole = createConstant("uvp", "University place")
         ...
         */
        @JvmField val VIDEOGRAPHER: CreativeRole = createConstant("vdg", "Videographer")
         ...
         */
        @JvmField val WRITER_OF_ADDED_COMMENTARY: CreativeRole = createConstant("wac", "Writer of added commentary")
         ...
         */
        @JvmField val WRITER_OF_ADDED_LYRICS: CreativeRole = createConstant("wal", "Writer of added lyrics")
         ...
         */
        @JvmField val WRITER_OF_ADDED_TEXT: CreativeRole = createConstant("wat", "Writer of added text")

        /**
         * A person, family, or organization contributing to a resource by providing an introduction to the original
         * work.
         */
        @JvmField val WRITER_OF_INTRODUCTION: CreativeRole = createConstant("win", "Writer of introduction")

        /**
         * A person, family, or organization contributing to a resource by providing a preface to the original work.
         */
        @JvmField val WRITER_OF_PREFACE: CreativeRole = createConstant("wpr", "Writer of preface")
         ...
         */
        @JvmField val WRITER_OF_SUPPLEMENTARY_TEXTUAL_CONTENT: CreativeRole =
